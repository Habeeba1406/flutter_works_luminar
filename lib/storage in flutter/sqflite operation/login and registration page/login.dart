...
import 'package:flutter_application_1/storage%20in%20flutter/sqflite%20operation/login%20and%20registration%20page/home.dart';
import 'package:flutter_application_1/storage%20in%20flutter/sqflite%20operation/login%20and%20registration%20page/login%20signup.dart';
...
class _Login_FormState extends State<Login_Form> {
  ...
  void logincheck(String email, String password) async {
    ...
    if (email == 'admin@gmail.com' && password == '123456') {
      ...
      var data = await sqlFunction.CheckLogin(email, password);
