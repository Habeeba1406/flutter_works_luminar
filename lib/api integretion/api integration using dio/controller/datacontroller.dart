...
import 'package:flutter_application_1/api%20integretion/api%20integration%20using%20dio/service/dio_service.dart';
...
class DataController extends GetxController {
  ...
  scrollToUp() {
    itemController.scrollTo(
        index: 0, duration: Duration(seconds: 3), curve: Curves.bounceInOut);
